...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(-22.7,-22.7).lineTo(22.7,-22.7).lineTo(22.7,22.7).lineTo(-22.7,22.7).closePath();
	this.shape.setTransform(22.725,22.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#000000").beginStroke().moveTo(-22.7,22.7).lineTo(-22.7,-22.7).lineTo(22.7,-22.7).lineTo(22.7,22.7).closePath();
	this.shape_1.setTransform(22.725,22.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.シンボル2, new cjs.Rectangle(-1,-1,47.5,47.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:96.7},33).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1,-0.5,47.5,120.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(61,69.4,1,1,0,0,0,28,27.9);

	this.instance_2 = new lib.symbol6();
	this.instance_2.setTransform(484.45,498.35,1,1,0,0,0,28,27.9);
	this.instance_2.compositeOperation = "screen";

	this.instance_3 = new lib.symbol6();
	this.instance_3.setTransform(284,498.35,1,1,0,0,0,28,27.9);
	this.instance_3.compositeOperation = "lighter";

	this.instance_4 = new lib.symbol6("synched",0);
	this.instance_4.setTransform(430.45,219.7,1,1,0,0,0,28,27.9);
	...
	this.instance_5.setTransform(345.2,219.7,1,1,0,0,0,28,27.9);
	...
	this.instance_6.setTransform(184,219.7,1,1,0,0,0,28,27.9);
	var instance_6Filter_3 = new cjs.ColorFilter(1,1,1,1,0,-255,0,0);
	this.instance_6.filters = [instance_6Filter_3];
	this.instance_6.cache(-2,-2,60,60);

	this.instance_7 = new lib.symbol6("synched",0);
	this.instance_7.setTransform(98.75,219.7,1,1,0,0,0,28,27.9);
	var instance_7Filter_4 = new cjs.ColorFilter(1,1,1,1,0,255,0,0);
	this.instance_7.filters = [instance_7Filter_4];
	this.instance_7.cache(-2,-2,60,60);

	this.instance_8 = new lib.symbol6("synched",0);
	this.instance_8.setTransform(411,69.4,1,1,0,0,0,28,27.9);
	var instance_8Filter_5 = new cjs.ColorFilter(0.2,0.2,0.2,1,103.2,200,76.8,0);
	this.instance_8.filters = [instance_8Filter_5];
	this.instance_8.cache(-2,-2,60,60);

	this.instance_9 = new lib.symbol6("synched",0);
	this.instance_9.setTransform(476.05,69.4,1,1,0,0,0,28,27.9);
	var instance_9Filter_6 = new cjs.ColorFilter(0.15,0.15,0.15,1,97.75,92.65,216.75,0);
	this.instance_9.filters = [instance_9Filter_6];
	this.instance_9.cache(-2,-2,60,60);

	this.instance_10 = new lib.symbol6("synched",0);
	this.instance_10.setTransform(343,69.4,1,1,0,0,0,28,27.9);
	var instance_10Filter_7 = new cjs.ColorFilter(0.04,0.04,0.04,1,222.72,92.16,182.4,0);
	this.instance_10.filters = [instance_10Filter_7];
	this.instance_10.cache(-2,-2,60,60);

	this.instance_11 = new lib.symbol6("synched",0);
	this.instance_11.setTransform(242,69.4,1,1,0,0,0,28,27.9);
	var instance_11Filter_8 = new cjs.ColorFilter(0.46,0.46,0.46,1,0,0,0,0);
	this.instance_11.filters = [instance_11Filter_8];
	this.instance_11.cache(-2,-2,60,60);

	this.instance_12 = new lib.symbol6("synched",0);
	this.instance_12.setTransform(180,69.4,1,1,0,0,0,28,27.9);
	var instance_12Filter_9 = new cjs.ColorFilter(0.44,0.44,0.44,1,142.8,142.8,142.8,0);
	this.instance_12.filters = [instance_12Filter_9];
	this.instance_12.cache(-2,-2,60,60);

	this.instance_13 = new lib.symbol6();
	this.instance_13.setTransform(384,498.35,1,1,0,0,0,28,27.9);
	this.instance_13.compositeOperation = "multiply";

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.beginLinearGradientFill(["#FF0000","#FFFF00","#00FF00","#00FFFF","#0000FF","#FF00FF","#FF0000"],[0,0.165,0.365,0.498,0.667,0.831,1],-151.1,0,151.2,0).beginStroke().moveTo(-151.1,33.6).lineTo(-151.1,-33.6).lineTo(151.1,-33.6).lineTo(151.1,33.6).closePath();
	this.shape_96.setTransform(383.875,497.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_96},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_4Filter_1).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_5Filter_2).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_6Filter_3).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_7Filter_4).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_8Filter_5).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_9Filter_6).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_10Filter_7).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_11Filter_8).wait(50));
	this.timeline.addTween(cjs.Tween.get(instance_12Filter_9).wait(50));

	// レイヤー_4
	this.instance_14 = new lib.シンボル1();
	this.instance_14.setTransform(63.7,302.75,1,1,0,0,0,22.7,22.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(50));

	// レイヤー_5
	this.instance_15 = new lib.symbol6("synched",0);
	this.instance_15.setTransform(98,484.35,1,1,0,0,0,28,27.9);
	var instance_15Filter_10 = new cjs.ColorFilter(1,1,1,1,0,-255,0,0);
	this.instance_15.filters = [instance_15Filter_10];
	this.instance_15.cache(-2,-2,60,60);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({alpha:0.4805},22).to({alpha:1},27).wait(1));
	this.timeline.addTween(cjs.Tween.get(instance_15Filter_10).to(new cjs.ColorFilter(0.12890625,1,1,1,169,75,0,0), 22).to(new cjs.ColorFilter(1,1,1,1,0,-255,0,0), 27).wait(1));

	// レイヤー_7
	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.beginFill().beginStroke("rgba(201,201,201,0.259)").setStrokeStyle(13,1,1).moveTo(118.7,-0.1).curveTo(118.7,49.1,83.9,83.9).curveTo(49.2,118.6,0,118.6).curveTo(-49.2,118.6,-84,83.9).curveTo(-118.7,49.1,-118.7,-0.1).curveTo(-118.7,-49.2,-84,-84).curveTo(-49.2,-118.8,0,-118.8).curveTo(49.2,-118.8,83.9,-84).curveTo(118.7,-49.2,118.7,-0.1).closePath().moveTo(267.8,-0).curveTo(267.8,110.9,189.3,189.3).curveTo(111,267.8,0,267.8).curveTo(-110.9,267.8,-189.4,189.3).curveTo(-267.7,110.9,-267.7,-0).curveTo(-267.7,-110.9,-189.4,-189.4).curveTo(-110.9,-267.7,0,-267.7).curveTo(111,-267.7,189.3,-189.4).curveTo(267.8,-110.9,267.8,-0).closePath().moveTo(170.5,-0).curveTo(170.5,70.6,120.5,120.5).curveTo(70.6,170.5,-0,170.5).curveTo(-70.7,170.5,-120.6,120.5).curveTo(-170.5,70.6,-170.5,-0).curveTo(-170.5,-70.7,-120.6,-120.6).curveTo(-70.7,-170.5,-0,-170.5).curveTo(70.6,-170.5,120.5,-120.6).curveTo(170.5,-70.7,170.5,-0).closePath().moveTo(223.5,-0).curveTo(223.5,92.6,158,158).curveTo(92.6,223.5,0,223.5).curveTo(-92.6,223.5,-158.1,158).curveTo(-223.5,92.6,-223.5,-0).curveTo(-223.5,-92.6,-158.1,-158.1).curveTo(-92.6,-223.5,0,-223.5).curveTo(92.6,-223.5,158,-158.1).curveTo(223.5,-92.6,223.5,-0).closePath().moveTo(20.4,-0.1).curveTo(20.4,8.3,14.4,14.3).curveTo(8.5,20.3,0,20.3).curveTo(-8.4,20.3,-14.4,14.3).curveTo(-20.4,8.3,-20.4,-0.1).curveTo(-20.4,-8.6,-14.4,-14.5).curveTo(-8.4,-20.5,0,-20.5).curveTo(8.5,-20.5,14.4,-14.5).curveTo(20.4,-8.6,20.4,-0.1).closePath().moveTo(68.3,-0.1).curveTo(68.3,28.2,48.3,48.1).curveTo(28.3,68.1,0,68.1).curveTo(-28.3,68.1,-48.2,48.1).curveTo(-68.2,28.2,-68.2,-0.1).curveTo(-68.2,-28.4,-48.2,-48.4).curveTo(-28.3,-68.3,0,-68.3).curveTo(28.3,-68.3,48.3,-48.4).curveTo(68.3,-28.4,68.3,-0.1).closePath();
	this.shape_97.setTransform(285.75,278.25);

	this.timeline.addTween(cjs.Tween.get(this.shape_97).wait(50));

	// stageBackground
	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.beginFill().beginStroke("rgba(0,0,0,0)").setStrokeStyle(1,1,1,3,true).moveTo(-285,-283).lineTo(285,-283).lineTo(285,283).lineTo(-285,283).closePath();
	this.shape_98.setTransform(275,273);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-285,283).lineTo(-285,-283).lineTo(285,-283).lineTo(285,283).closePath();
	this.shape_99.setTransform(275,273);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_99},{t:this.shape_98}]}).wait(50));

	this.filterCacheList = [];
	this.filterCacheList.push({instance: this.instance_15, startFrame:1, endFrame:22, x:-2, y:-2, w:60, h:60});
	this.filterCacheList.push({instance: this.instance_15, startFrame:0, endFrame:0, x:-2, y:-2, w:60, h:60});
	this.filterCacheList.push({instance: this.instance_15, startFrame:23, endFrame:49, x:-2, y:-2, w:60, h:60});
	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(286.5,276,364.29999999999995,276.5);
// library properties:
lib.properties = {
